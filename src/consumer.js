...
var consumer = kafka.consumer({ groupId: (0, uuid_1.v4)() }); // we need a unique groupId I'll explain down
function connect() {
    var _this = this;
    return consumer.connect().then(function () {
        return consumer.subscribe({ topic: 'quickstart-events' }).then(function () {
            return consumer.run({
